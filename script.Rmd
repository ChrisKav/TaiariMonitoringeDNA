...
taxa.rich.table <- data.frame(rbind(
  c("Bacteria", ntaxa(tax_glom(subset_taxa(physeq, superkingdom == "Bacteria"), "family")), ntaxa(tax_glom(subset_taxa(physeq, superkingdom == "Bacteria"), "genus"))),
  c("Fungi", ntaxa(tax_glom(subset_taxa(physeq, kingdom == "Fungi"), "family")), ntaxa(tax_glom(subset_taxa(physeq, kingdom == "Fungi"), "genus"))),
  c("Chlorphyta", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Chlorophyta"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Chlorophyta"), "genus"))),
  c("Fungi", ntaxa(tax_glom(subset_taxa(physeq, kingdom == "Fungi"), "family")), ntaxa(tax_glom(subset_taxa(physeq, kingdom == "Fungi"), "genus"))),
  c("Protists", ntaxa(tax_glom(protozoa, "family")), ntaxa(tax_glom(protozoa, "genus"))),
  c("Diatoms", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Bacillariophyta"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Bacillariophyta"), "genus"))),
  c("Plants", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Streptophyta"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Streptophyta"), "genus"))),
  c("Rotifer", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Rotifera"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Rotifera"), "genus"))),
  c("Tardigrade", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Tardigrada"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Tardigrada"), "genus"))),
  c("Porifera", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Porifera"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Porifera"), "genus"))),
  c("Cnidaria", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Cnidaria"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Cnidaria"), "genus"))),
  c("Gastrotricha", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Gastrotricha"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Gastrotricha"), "genus"))),
  c("Platyhelminthes", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Platyhelminthes"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Platyhelminthes"), "genus"))),
  c("Nemertea", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Nemertea"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Nemertea"), "genus"))),
  c("Nematoda", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Nematoda"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Nematoda"), "genus"))),
  c("Annelida", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Annelida"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Annelida"), "genus"))),
  c("Mollusca", ntaxa(tax_glom(subset_taxa(physeq, phylum == "Mollusca"), "family")), ntaxa(tax_glom(subset_taxa(physeq, phylum == "Mollusca"), "genus"))),
  c("Crustacea", ntaxa(tax_glom(crustacea, "family")), ntaxa(tax_glom(crustacea, "genus"))),
  c("Insects", ntaxa(tax_glom(subset_taxa(physeq, class == "Insecta"), "family")), ntaxa(tax_glom(subset_taxa(physeq, class == "Insecta"), "genus"))),
  c("Fish", ntaxa(tax_glom(subset_taxa(physeq, class == "Actinopteri" | class=="Hyperoartia"), "family")), ntaxa(tax_glom(subset_taxa(physeq, class == "Actinopteri" | class=="Hyperoartia"), "genus"))),
  c("Birds", ntaxa(tax_glom(subset_taxa(physeq, class == "Aves"), "family")), ntaxa(tax_glom(subset_taxa(physeq, class == "Aves"), "genus")))
))
